...
def main():
    ...
    goal_pose2 = create_pose_stamped(nav, 4.0, -5.0, 1.57)
    goal_pose3 = create_pose_stamped(nav, 5.0, -5.0, 3.14)
    goal_pose4 = create_pose_stamped(nav, 5.0, -4.0, 3.14)
    goal_pose5 = create_pose_stamped(nav, -9.0, 9.0, -1.57)
    goal_pose6 = create_pose_stamped(nav, 3.0, -5.0, 0.00)
    goal_pose7 = create_pose_stamped(nav, -9.0, 0.0, 1.57)
    goal_pose8 = create_pose_stamped(nav, 0.0, 0.0, 0.0)
